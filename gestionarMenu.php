...
<body>
      <header>
        ...
        <section class="animated col-lg-8 main container bounceInUp">
                        ...
                        <form role="form" onsubmit="return validarForm()" name="formMenu" action="script/validarGestionarMenus.php" method="POST">
                                  <article class="crear clearfix">
                            <div class="panel panel-default">
                            
                              <div class="panel-heading">
                                <h3 class="panel-title"><b>Menus Disponibles</b></h3>
                              </div>
                                              ...
                                              <tbody>
                                                <?php
                                                  ...
                                                  //echo "<option value='".$col['0']."'>".$col['2']."</option>";
                                                    ...
                                                    $check_P = $connV->query("CALL sp_gestionarPerfiles(6,'$IdEntrenador','','')");
