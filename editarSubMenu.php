...
<body>
      <header>
        ...
        <section class="animated col-lg-4 main container bounceInUp">
                        ...
                        <form role="form" onsubmit="return validarForm()" name="formPerfil" action="script/validarEditarSubMenu.php" method="POST">
                                        <center>
                                        <div class="tit"><h2><b>EDITAR PERFIL</b></h2>
                                          ...
                                          <fieldset>
                                                <legend>
                                                  ...
                                                  $consulta="CALL sp_gestionarSubMenu(6,'$idObtenido','','','')";
                                                     ...
                                                     <div class='form-group col-lg-8'>
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         <input class='form-control' style='border-radius:15px;' type='text' placeholder='Nombre' maxlength='20' name='nombreSubMenu' id='nombreSubMenu' value='".$col[2]."' />
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class='col-lg-2'>
                                                      ...
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         ...
                                                         <center><textarea class='form-control' style='border-radius:15px;' placeholder='Introduzca la descripccion...' name='descSubMenu' id='descSubMenu' columns='7' rows='5' >".$col[3]."</textarea></center>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class='col-lg-2'>
