...
<body>
      <header>
        ...
        <section class="animated col-lg-8 main container bounceInUp">
                        ...
                        <form role="form" onsubmit="return validarForm()" name="formMenu" action="script/validarGestionarEntrenadores.php" method="POST">
                                  <article class="crear clearfix">
                            <div class="panel panel-default">
                            
                              <div class="panel-heading">
                                <h3 class="panel-title"><b>Entrenadores/Usuarios Disponibles</b></h3>
                              </div>
                                            ...
                                            <table class="table table-bordered table-striped bs-table">
                                              ...
                                              <tbody>
                                                <?php
                                                  ...
                                                  $consulta="CALL sp_gestionarEntrenador(5,'','','','','','','','')";
                                                  ...
                                                  //echo "<option value='".$col['0']."'>".$col['2']."</option>";
                                                    ...
                                                    $check_P = $connV->query("CALL sp_gestionarPerfiles(6,'$IdEntre','','')");
