...
<head>
    ...
    <title>PKMN-Administrador</title>
...
<body>
        ...
        <section class="col-lg-10 main container">
                ...
                <section class="animated col-lg-9 main container fadeInLeft">
                    <div class="principal">
                    <hr>
                        <div align="center" class="animated row fadeInLeft">
