...
<head>
  ...
  <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    ...
    <script src="js/bootstrap.min.js"></script>
     <script src="js/registrarMenu.js"></script>
...
<body>
      <header>
        ...
        <section class="animated col-lg-4 main container bounceInUp">
                        ...
                        <form role="form" onsubmit="return validarForm()" name="formMenu" action="script/validarRegistroMenu.php" method="POST">
                                        <center>
                                        <div class="tit"><h2><b>REGISTRAR NUEVO MENU</b></h2>
                                            <hr>
                                          <fieldset>
                                                <legend>
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" type="text" placeholder="Nombre" maxlength="20" name="nombreMenu" id="nombreMenu" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label class="control-label">Asignarlo al Perfil</label></center>
                                                        </td>
                                                        <td>
                                                          <select style="border-radius:15px;" id="tipoEntrenador" name="tipoEntrenador">
                                                      ...
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         ...
                                                         <center><textarea class="form-control" style="border-radius:15px;" placeholder="Introduzca la descripccion..." name="descMenu" id="descMenu" columns="7" rows="5" required></textarea></center>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
