...
<head>
  ...
  <script src="js/registrarEntrenador.js"></script>
...
<body>
      <header>
        ...
        <section class="animated col-lg-4 main container bounceInUp">
                                        ...
                                        <form  action="script/validarRegistroEntrenador.php" method="POST">
                                        <center>
                                        <div class="tit"><h2><b>REGISTRAR ENTRENADOR</b></h2>
                                            <hr>
                                          <fieldset>
                                                <legend>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="Rnombre" class="control-label">Nombre</label></center>
                                                        </td>
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" type="text" placeholder="Nombre" maxlength="20" name="Rnombre" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="Ralias" class="control-label">Alias</label></center>
                                                        </td>
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" placeholder="Alias" type="text" maxlength="20" name="Ralias" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="RTipoEntrenador" class="control-label">¿Tipo de Entrenador?</label></center>
                                                        </td>
                                                        <td>
                                                          <center><select  style="border-radius:15px;" name="RTipoEntrenador" requerid>
                                                            <!--<option style="border-radius:15px;" value="-1">Seleccionar</option>-->
                                                            <?php
                                                               //Llenar cmb
                                                        ...
                                                        <tr>
                                                         ...
                                                         <center><label class="control-label">¿Eres un chico o una chica?</label></center>
                                                            ...
                                                            <div class="form-control " style="border-radius:15px;">
                                                                <center>
                                                                  <label style="color:black;" for="RsexoM" class="control-label">Masculino</label>
                                                                  <input type="radio" name="Rsexo" value="M" checked="checked"/>
                                                                  <label style="color:black;" for="RsexoF" class="control-label">Femenino</label>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="Rrival" class="control-label">Rival</label></center>
                                                        </td>
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" placeholder="¿Como se llama tu rival?" type="text" maxlength="20" name="Rrival" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="Rpass" class="control-label">Contraseña</label></center>
                                                        </td>
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" placeholder="Contraseña" type="password" maxlength="20" name="Rpass" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                         <center><label for="Rrpass" class="control-label">Confirmar Contraseña</label></center>
                                                        </td>
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" placeholder="Confirma tu contraseña" type="password" maxlength="20" name="Rrpass" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                    ...
                                                    <center><button class="btn btn-primary btn-lg" name="btn_registro" type="submit">REGISTRAR</button></center>
                                                    <br>
