...
<body>
      <header>
        ...
        <section class="animated col-lg-4 main container bounceInUp">
                        ...
                        <form role="form" onsubmit="return validarForm()" name="formPerfil" action="script/validarRegistroPerfil.php" method="POST">
                                        <center>
                                        <div class="tit"><h2><b>REGISTRAR NUEVO PERFIL</b></h2>
                                            <hr>
                                          <fieldset>
                                                <legend>
                                                     ...
                                                     <div class="form-group col-lg-8">
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         <input class="form-control" style="border-radius:15px;" type="text" placeholder="Nombre" maxlength="20" name="nombrePerfil" id="nombrePerfil" required/>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
                                                      ...
                                                      <tr>
                                                       <td>
                                                        ...
                                                        <td>
                                                         ...
                                                         <center><textarea class="form-control" style="border-radius:15px;" placeholder="Introduzca la descripccion..." name="descPerfil" id="descPerfil" columns="7" rows="5" required></textarea></center>
                                                        </td>
                                                       </tr>
                                                      </div>
                                                      <div class="col-lg-2">
